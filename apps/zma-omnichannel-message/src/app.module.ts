...
import { MessageMutation } from './controllers/mutations';
import { ClientResolver, MasterDataResolver, MessageResolver } from './controllers/resolvers';
...
import { DaprPubSubModule } from './frameworks/dapr/pubsub/dapr.pubsub.module';
        ...
        transports: [
          new winston.transports.Console({
            format: winston.format.combine(
              ...
              winston.format.ms(),
              nestWinstonModuleUtilities.format.nestLike('zma-omnichannel-message', {
                colors: true,
                prettyPrint: true,
              }),
            ),
    ...
    GraphQLModule.forRoot<YogaDriverConfig>({
      ...
      autoSchemaFile:
        process.env.NODE_ENV === 'development'
          ? join(process.cwd(), 'graphqls/zma-omnichannel-message/schema.graphql')
          : true,
